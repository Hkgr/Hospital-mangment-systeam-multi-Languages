...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{ trans('Patients.patients') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  {{ trans('Patients.edit_patient') }}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" name="Gender" required>
                                <option value="1" {{$Patient->Gender == 1 ? 'selected':''}}>{{ trans('Patients.male') }}</option>
                                <option value="2" {{$Patient->Gender == 2 ? 'selected':''}}>{{ trans('Patients.female') }}</option>
                            </select>
                        </div>

                        <div class="col">
                            <label>{{ trans('Patients.blood_group') }}</label>
