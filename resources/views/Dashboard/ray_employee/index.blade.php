...
@section('title')
   {{ trans('RayEmployee.EmployeeList') }}
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
                                                        <h4 class="content-title mb-0 my-auto">{{ trans('RayEmployee.Rays') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('RayEmployee.EmployeeList') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th>{{ trans('RayEmployee.Name') }}</th>
                                                <th>{{ trans('RayEmployee.Email') }}</th>
                                                <th>{{ trans('RayEmployee.CreatedAt') }}</th>
                                                <th>{{ trans('RayEmployee.Actions') }}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
