        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('Ambulance.update','test')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" name="car_type">
                                <option value="1" {{$ambulance->car_type == 1 ? 'selected':''}}>{{ trans('Dashboard/Ambulances.Owned') }}</option>
                                <option value="2" {{$ambulance->car_type == 2 ? 'selected':''}}>{{ trans('Dashboard/Ambulances.Rented') }}</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{ trans('Dashboard/Ambulances.IsAvailable') }}</label>
                            &nbsp;
