        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{route('')}}">الكشوفات</a></li>
            ...
            <li class="slide">
				...
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('') }}">قائمة المواعيد</a></li>
					<li><a class="slide-item" href="{{ route('') }}">المواعيد المنتهية</a></li>
				</ul>
			</li>
