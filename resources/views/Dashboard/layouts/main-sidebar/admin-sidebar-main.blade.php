...
<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        ...
        <li class="side-item side-item-category">{{ trans('main-sidebar_trans.Menu') }}</li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('Sections.index2')}}">{{ trans('main-sidebar_trans.AddSection') }}</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('Doctors.create')}}">{{ trans('main-sidebar_trans.AddDoctor') }}</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.Patients') }}</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('Patients.create')}}">{{ trans('main-sidebar_trans.AddPatient') }}</a></li>
                <li><a class="slide-item" href="{{ route('Patients.index') }}">{{ trans('main-sidebar_trans.PatientList') }}</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.Invoices') }}</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('single_invoices') }}">{{ trans('main-sidebar_trans.Single_invoices') }}</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.Accounts') }}</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.Rays') }}</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('ray_employee.index') }}">{{ trans('main-sidebar_trans.EmployeesList') }}</a></li>
                <li><a class="slide-item" href="{{ route('admin.ray_invoices.index') }}">{{ trans('main-sidebar_trans.RayBills') }}</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.Laboratory') }}</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('laboratorie_employee.index') }}">{{ trans('main-sidebar_trans.EmployeesList') }}</a></li>
                <li><a class="slide-item" href="{{ route('admin.laboratorie.index') }}">{{ trans('main-sidebar_trans.LaboratoryBills') }}</a></li>
            </ul>
        </li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.Appointments') }}</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('appointments.create') }}">{{ trans('main-sidebar_trans.AddAppointment') }}</a></li>
                <li><a class="slide-item" href="{{ route('appointments.index') }}">{{ trans('main-sidebar_trans.AppointmentsList') }}</a></li>
                <li><a class="slide-item" href="{{ route('appointments.index2') }}">{{ trans('main-sidebar_trans.ConfirmedAppointmentsList') }}</a></li>
                <li><a class="slide-item" href="{{ route('appointments.ExpiredDates') }}">{{ trans('main-sidebar_trans.ExpiredAppointmentsList') }}</a></li>
            </ul>
        </li>
