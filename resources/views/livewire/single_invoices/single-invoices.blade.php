    ...
    <form wire:submit.prevent="store" autocomplete="off">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <select wire:model="insurance_id" class="form-control">
                            ...
                            <table class="table table-striped mg-b-0 text-md-nowrap" style="text-align: center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input wire:model="insurance_discount" type="text" class="form-control" readonly></td>
                                        <td><input wire:model="company_rate" type="text" class="form-control" readonly></td>
                                        ...
                                        <td><input type="text" class="form-control" readonly value="{{$total}}"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div><!-- bd -->
