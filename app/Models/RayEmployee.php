...
class RayEmployee extends Authenticatable
{
    ...
    {
        static::created(function (RayEmployee $employee) {
            ...
            // Ensure a default.png exists under ray_employees folder for views expecting foldered path
            try {
                $defaultPath = public_path('Dashboard/img/default.png');
                $targetDir = public_path('Dashboard/img/ray_employees');
    ...
    public function getAvatarPathAttribute(): string
    {
        ...
        if ($filename && $filename !== 'default.png') {
            return asset('Dashboard/img/ray_employees/' . $filename);
        }
